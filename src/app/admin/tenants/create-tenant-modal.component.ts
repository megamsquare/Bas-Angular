...
import { 
    ...
    TenantServiceProxy, SubscribableEditionComboboxItemDto, PermissionServiceProxy } from 
...
export class CreateTenantModalComponent extends AppComponentBase {
    ...
    show() {
        this.active = true;
        this.init();
     this._permissionService.getPermissionsForTenant(undefined).subscribe(result => {
    ...
    save(): void {
        this.saving = true;
        this.tenant.grantedPermissionNames = this.permissionTree.getGrantedPermissionNames();
